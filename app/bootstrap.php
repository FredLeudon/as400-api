...
require_once $APP_DIR . '/Digital/ADATTDRO.php';
require_once $APP_DIR . '/Digital/AEATTETE.php';
require_once $APP_DIR . '/Digital/ANATTNOM.php';
require_once $APP_DIR . '/Digital/APARGPRD.php';
require_once $APP_DIR . '/Digital/APAVTPRD.php';
require_once $APP_DIR . '/Digital/ASATTSERAP.php';
require_once $APP_DIR . '/Digital/ASSMARQFIC.php';
require_once $APP_DIR . '/Digital/ATARGTXT.php';
require_once $APP_DIR . '/Digital/ATAVTTXT.php';
require_once $APP_DIR . '/Digital/BPBCLPRT.php';
require_once $APP_DIR . '/Digital/CACOMART.php';
require_once $APP_DIR . '/Digital/CACOMARTVC.php';
require_once $APP_DIR . '/Digital/DICOKEY.php';
require_once $APP_DIR . '/Digital/DICOTEXTE.php';
require_once $APP_DIR . '/Digital/EVENSVAL.php';
require_once $APP_DIR . '/Digital/GLN.php';
require_once $APP_DIR . '/Digital/GPGABPRT.php';
require_once $APP_DIR . '/Digital/LALSTATTS.php';
require_once $APP_DIR . '/Digital/LNLIBNOM.php';
...
require_once $APP_DIR . '/Digital/MARQUES.php';
