 ...
 */
final class PXNROUGE extends clFichier
{
    protected static string $table = 'PXNROUGE';
     ...
     */
    public static function getNouveauPrixRougeArticle(\PDO $pdo, string $articleId): ?static
    {
        try {
            $library = 'FCMBI';
