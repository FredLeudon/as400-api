...
final class Prices
{
    ...
    public static function getCustomerProductFullPrice(
        PDO $pdo,
        string $companyCode,
        string $customerCode,
        string $productCode,
    ...
    public static function bulkCustomerProductsFullPrices(PDO $pdo, string $companyCode, string $customerCode, array $body): array
    {
        // 1) Date optionnelle (ISO 8601)
        $date = null;
        if (array_key_exists('date', $body)) {
        ...
        foreach ($body['items'] as $idx => $item) {
            ...
            try {
                $price = self::getCustomerProductFullPrice(
                    pdo: $pdo,
                    companyCode: $companyCode,
                    customerCode: $customerCode,
                    productCode: $code,
